            ...
            while(hwndChild) {
                ...
                if(nRet && strncmp(szClassName, "msctls_updown32", sizeof(szClassName)))
                    ...
                    */
                    ...
                    if(tabdat->m_SpinProc == NULL) {
                        _DebugPopup(0, "found the scroller");
                        OldSpinCtrlProc = tabdat->m_SpinProc = (WNDPROC)SetWindowLong(hwndChild, GWL_WNDPROC, (LONG)SpinCtrlSubclassProc);
                    }
