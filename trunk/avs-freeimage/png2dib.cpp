...
__declspec( dllexport ) PLUGININFOEX* MirandaPluginInfoEx( DWORD mirandaVersion )
{
	if ( mirandaVersion < PLUGIN_MAKE_VERSION( 0,4,3,0 )) {
		//MessageBox( NULL, _T("The png2dib plugin cannot be loaded. It requires Miranda IM 0.5 or later."), _T("png2dib Plugin"), MB_OK|MB_ICONWARNING|MB_SETFOREGROUND|MB_TOPMOST );
		return NULL;
	}
