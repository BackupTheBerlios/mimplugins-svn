		...
		case WM_NCPAINT:
			{
				...
				if(g_framelessSkinmode) {
					...
					pContainer->rcClose.top = pContainer->rcMin.top = pContainer->rcMax.top = 7;
					pContainer->rcClose.bottom = pContainer->rcMin.bottom = pContainer->rcMax.bottom = 7 + g_titleBarButtonSize.cy;
